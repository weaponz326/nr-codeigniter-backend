    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            access = Access(
                ...
                contractors_access=request.data.get("contractors_access"),
                equipment_access=request.data.get("equipment_access"),
                manufacturing_access=request.data.get("manufacturing_access"),
                ...
                projects_access=request.data.get("projects_access"),
                purchasing_access=request.data.get("purchasing_access"),
                schedule_access=request.data.get("schedule_access"),
                settings_access=request.data.get("settings_access"),
                stock_access=request.data.get("stock_access"),
                tasks_access=request.data.get("tasks_access"),
                workers_access=request.data.get("workers_access"),
            )
...
class AllActivityListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        production = self.request.query_params.get('user', None)
        if production is not None:
            queryset = queryset.filter(production__production=production)
        return queryset
