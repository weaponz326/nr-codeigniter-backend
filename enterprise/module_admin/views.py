    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            access = Access(
                ...
                acounts_access=request.data.get("acounts_access"),
                admin_access=request.data.get("admin_access"),
                appraisal_access=request.data.get("appraisal_access"),
                assets_access=request.data.get("assets_access"),
                attendance_access=request.data.get("attendance_access"),
                budget_access=request.data.get("budget_access"),
                employees_access=request.data.get("employees_access"),
                files_access=request.data.get("files_access"),
                leave_access=request.data.get("leave_access"),
                ledger_access=request.data.get("ledger_access"),
                letters_access=request.data.get("letters_access"),
                payroll_access=request.data.get("payroll_access"),
                portal_access=request.data.get("portal_access"),
                procurement_access=request.data.get("procurement_access"),
                reception_access=request.data.get("reception_access"),
